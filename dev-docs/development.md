...
## Flipper
[Flipper](https://github.com/flippercloud/flipper) is used to toggle certain features on HCB. Flipper can be accessed at [http://localhost:3000/flipper/features](http://localhost:3000/flipper/features). To enable a feature, press "Add Feature", paste in the name of a feature from [this list](https://hcb.hackclub.com/api/flags), and then press "Fully Enable".