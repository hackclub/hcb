...
Afterwards, [`TransactionEngine::Nightly`](https://github.com/hackclub/hcb/blob/main/app/services/transaction_engine/nightly.rb) continues by calling [`TransactionEngine::HashedTransactionService::RawStripeTransaction::Import`](https://github.com/hackclub/hcb/blob/main/app/services/transaction_engine/canonical_transaction_service/import), which loops through each of these [`RawStripeTransaction`](https://github.com/hackclub/hcb/blob/main/app/models/raw_stripe_transaction.rb)s to create a “hashed transaction”.
