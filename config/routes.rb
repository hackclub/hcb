...
Rails.application.routes.draw do
  ...
  resources :events, except: [:new, :create, :edit], concerns: :commentable, path: "/" do
    ...
    get "card_grants/card_overview", to: "card_grants#card_overview", as: :card_grant_card_overview
    get "card_grants/transaction_overview", to: "card_grants#transaction_overview", as: :card_grant_transaction_overview
