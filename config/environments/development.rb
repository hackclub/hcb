...
Rails.application.configure do
  ...
  # Disabled because of shared controllers concerns:
  # https://www.shakacode.com/blog/rails-adds-ability-to-raise-error-on-missing-callback-actions/#when-to-avoid-this-feature
