...
class UsersController < ApplicationController
  ...
  def update
    ...
    saved = ActiveRecord::Base.transaction do
      ...
      if update_payout_method
        payout_update = IllegalEntity::PayoutMethodService::Update.new(
          user: @user,
  ...
  def payout_method_details_params
    ...
    permitted =
      ...
      when IllegalEntity::PayoutMethod::Check.name
      ...
      when IllegalEntity::PayoutMethod::Wire.name
        params.require(:user).permit(payout_method_wire: [
          ...
          :bic_code,
          :account_number
        ] + IllegalEntity::PayoutMethod::Wire.recipient_information_accessors)[:payout_method_wire]
      when IllegalEntity::PayoutMethod::WiseTransfer.name
        params.require(:user).permit(payout_method_wise_transfer: [
          ...
          :recipient_country,
          :currency,
        ] + IllegalEntity::PayoutMethod::WiseTransfer.recipient_information_accessors)[:payout_method_wise_transfer]
      when IllegalEntity::PayoutMethod::AchTransfer.name
        params.require(:user).permit(payout_method_attributes: [
                                       :account_number,
                                       :routing_number
                                     ])[:payout_method_attributes]
