...
class EventsController < ApplicationController
  ...
  def request_call
    ...
    EventMailer.with(event: @event, user: current_user).ops_call_requested.deliver_now
    EventMailer.with(event: @event, user: current_user).user_call_requested.deliver_now
