...
class ReceiptsController < ApplicationController
  ...
  def metadata
    ...
    render json: { name: @receipt.file.blob.filename, total: @receipt.extracted_total_amount_cents / 100.0, seller_name: @receipt.extracted_merchant_name, seller_address_zip: @receipt.extracted_merchant_zip_code }
  end
