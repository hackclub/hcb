...
class OrganizerPositionInvite
  class RequestsController < ApplicationController
    ...
    def approve
      ...
      service = OrganizerPositionInviteService::Create.new(event: link.event, sender: current_user, user_email: @request.requester.email, is_signee: false, role:, enable_spending_controls:, initial_control_allowance_amount:, request: @request)
