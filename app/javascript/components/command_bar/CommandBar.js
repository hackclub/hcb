...
export default function CommandBar({ admin = false, admin_override_pretend = false, adminUrls = {} }) {
  return (
    <div style={{ position: 'relative', zIndex: '1000' }}>
      <KBarProvider
        actions={[...initalActions, ...(admin || admin_override_pretend ? adminActions(adminUrls, !admin && admin_override_pretend) : [])]}
        options={{
