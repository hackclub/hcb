  ...
  showPreview() {
    ...
    if (fileName) {
      ...
      this.clearTarget.addEventListener('click', () => {
        ...
        this.previewTarget.innerHTML = this.placeholderValue;
        this.previewTarget.classList.remove('active');
      });
      this.clearTarget.appendChild(this.clearTarget);
    }
