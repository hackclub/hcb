...
module UserService
  class EnrollSmsAuth
    ...
    rescue TwilioVerificationService::UnsupportedCountryError
      raise SMSEnrollmentError, "SMS verification is not available for your phone number's country. Please contact support at hcb@hackclub.com."
    end
