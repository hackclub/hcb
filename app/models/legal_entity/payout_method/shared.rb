  ...
  class PayoutMethod < ApplicationRecord
    module Shared
      ...
      included do
        ...
        validate do
          if LegalEntity::PayoutMethod::UNSUPPORTED_METHODS.include?(self.class)
      ...
      class_methods do
        def unsupported?
          LegalEntity::PayoutMethod::UNSUPPORTED_METHODS.key?(self)
        end

        def unsupported_details
          LegalEntity::PayoutMethod::UNSUPPORTED_METHODS[self]
        end
      end
    end
  end
