...
class Event < ApplicationRecord
  ...
  has_many :pinned_ledger_items, -> { includes(hcb_code: [:canonical_transactions, :canonical_pending_transactions]) }, through: :ledger, source: :pinned_items, class_name: "Ledger::Item"
