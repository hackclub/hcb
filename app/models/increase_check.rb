...
class IncreaseCheck < ApplicationRecord
  ...
  def stop!
    return unless column_id.present? && (column_initiated? || column_issued?)
  ...
  def reissue!
    return unless column_id.present? && (column_initiated? || column_issued? || column_pending_stop? || column_stopped?)
