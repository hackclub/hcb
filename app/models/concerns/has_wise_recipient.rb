  ...
  included do
    ...
    def self.information_required_for(currency)
      ...
      if currency.in?(%w[AED BGN CHF CZK DKK EGP EUR GBP GEL HUF ILS NOK PKR PLN RON SEK TRY UAH])
        ...
        fields << { type: :check_box, key: "use_same_email_for_interac", label_options: { "x-text": "email ? `Use '${email}' for Interac?` : 'Use the same email for Interac?'" }, conditional: "account_type == 'interac'" }
