...
class HcbCode < ApplicationRecord
  ...
  def disbursement?
    hcb_i1.in?([
      ::TransactionGroupingEngine::Calculate::HcbCode::DISBURSEMENT_CODE,
      ::TransactionGroupingEngine::Calculate::HcbCode::OUTGOING_DISBURSEMENT_CODE,
      ::TransactionGroupingEngine::Calculate::HcbCode::INCOMING_DISBURSEMENT_CODE,
    ])
  end
