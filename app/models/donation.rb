...
class Donation < ApplicationRecord
  ...
  # We have some historical recurring donations with disposable emails.
  validates :email, nondisposable: true, on: :create, unless: -> { recurring? && !initial_recurring_donation? }
