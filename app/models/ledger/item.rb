  ...
  class Item < ApplicationRecord
    ...
    def calculate_status
      unless canonical_pending_transactions.declined.any?
        ...
        return :settled if linked_object_type == "Disbursement::Outgoing" && (linked_object.counterparty.canonical_pending_transactions.fronted.any? || linked_object.pending? || linked_object.in_transit?)
