...
class User < ApplicationRecord
  ...
  has_one :person_legal_entity_user, -> { where(legal_entity_id: IllegalEntity.where(entity_type: :person).select(:id)) }, class_name: "LegalEntityUser", inverse_of: :user
  ...
  def can_update_payout_method?
    ...
    return true unless default_payout_method&.details.is_a?(IllegalEntity::PayoutMethod::WiseTransfer)
