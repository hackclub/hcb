...
module ApplicationHelper
  ...
  def help_message
    message = "Contact the HCB team at #{help_email} or call #{help_phone} for urgent requests.<br/>HCB is fiscally sponsored by The Hack Foundation (d.b.a. Hack Club), a 501(c)(3) nonprofit with EIN 81-2908499."
