...
module StaticPagesHelper
  ...
  def card_to(name, path, **options)
    ...
    pin = inline_icon("pin", class: "pin transition-opacity group-hover:opacity-100 absolute top-0 right-0 opacity-0", size: 24, color: "var(--muted)", "data-pinnable-cards-pin": "", "data-action": "click->pinnable-cards#toggle")
