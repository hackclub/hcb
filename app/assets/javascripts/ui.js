...
// A frame response renders the flash next to the frame, but Turbo keeps only
// the frame itself. Pull it out of the response and show it under the popover's
// title, or on the page when the request came from a frame elsewhere.
