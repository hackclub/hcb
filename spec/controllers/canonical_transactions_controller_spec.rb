...
RSpec.describe CanonicalTransactionsController do
  ...
  describe "#set_category" do
    it "sets the transaction category" do
      ...
      post(:set_category, params: { id: ct.id, canonical_transaction: { category_name: "Donations" } }, as: :html)
  ...
  it "clears the transaction category if the param is blank" do
    ...
    post(:set_category, params: { id: ct.id, canonical_transaction: { category_name: "" } }, as: :html)
