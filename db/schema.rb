...
ActiveRecord::Schema[7.2].define(version: 2025_08_11_204239) do
  ...
  create_table "canonical_pending_transaction_categories", force: :cascade do |t|
    t.bigint "transaction_category_id", null: false
    t.bigint "canonical_pending_transaction_id", null: false
    t.text "assignment_strategy", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["canonical_pending_transaction_id"], name: "idx_on_canonical_pending_transaction_id_510f53a010", unique: true
    t.index ["transaction_category_id"], name: "idx_on_transaction_category_id_b389fdeaab"
  end
  ...
  create_table "canonical_transaction_categories", force: :cascade do |t|
    t.bigint "transaction_category_id", null: false
    t.bigint "canonical_transaction_id", null: false
    t.text "assignment_strategy", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["canonical_transaction_id"], name: "idx_on_canonical_transaction_id_83a8a6bf99", unique: true
    t.index ["transaction_category_id"], name: "idx_on_transaction_category_id_5691e8a7b0"
  end
  ...
  add_foreign_key "canonical_pending_transaction_categories", "canonical_pending_transactions"
  add_foreign_key "canonical_pending_transaction_categories", "transaction_categories"
  add_foreign_key "canonical_pending_transactions", "raw_pending_stripe_transactions"
  add_foreign_key "canonical_transaction_categories", "canonical_transactions"
  add_foreign_key "canonical_transaction_categories", "transaction_categories"
